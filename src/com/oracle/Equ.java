...
public class Equ implements Serializable {
    ...
    private String table_name;
		...
		private int id;
		private int value;
		private String sid;//��Ƭ���
		private String did;//�������
		private String stdate; //�豸���ΰ����������
		private String sdate;//��ѯ��ʼʱ��
		private String edate;//��ѯ����ʱ��
		private String redate; //�������������
		private String pname;//�豸������Ŀϵͳ����
		private String use;//�豸��;
		private String ownname; //�豸�ʲ���λ/����/��ϵ��/�绰
		private String proname;//ϵͳ�����̣������̣�����/��ϵ��/�绰
		private String manname;//ϵͳά������������/�绰/��������
		private String agename;//��ά��λ����/��ϵ��/�绰
		private String mantyp;//ά����ʽ
		private String name;
		private int id1;
		private String sid1;//��Ƭ���
		private String did1;//�������
		private String stdate1; //�豸���ΰ����������
		private String sdate1;//��ѯ��ʼʱ��
		private String edate1;//��ѯ����ʱ��
		private String redate1; //�������������
		private String pname1;//�豸������Ŀϵͳ����
		private String use1;//�豸��;
		private String ownname1; //�豸�ʲ���λ/����/��ϵ��/�绰
		private String proname1;//ϵͳ�����̣������̣�����/��ϵ��/�绰
		private String manname1;//ϵͳά������������/�绰/��������
		private String agename1;//��ά��λ����/��ϵ��/�绰
		private String mantyp1;//ά����ʽ

		//IT�豸������ϸ
		private String sname;//�豸���ƣ����ͣ�
		private String styp;//Ʒ��/�ͺ�
		private String styp1;//Ʒ��/�ͺ�
		private String styp2;//Ʒ��/�ͺ�
		private String pos; //����/����λ��
		private String ip;//IP��ַ/����/����
		private String port;//���߱��/�������˿ں�/���߼ܶ˿ں�

		private String cpu;//CPU�ͺ�/��������
		private String memory;//�ڴ�
		private String disk;//Ӳ��
		private String syn;//����ϵͳ�汾

		private String oracle;//���ݿ�汾
		private String sn;//�豸���к�
		private String oth;//��ע

		private String sname1;//�豸���ƣ����ͣ�

		private String pos1; //����/����λ��
		private String ip1;//IP��ַ/����/����
		private String port1;//���߱��/�������˿ں�/���߼ܶ˿ں�
		private String cpu1;//CPU�ͺ�/��������
		private String memory1;//�ڴ�
		private String disk1;//Ӳ��
		private String syn1;//����ϵͳ�汾
		private String oracle1;//���ݿ�汾
		private String sn1;//�豸���к�
		private String oth1;//��ע


		private String sroot;//ϵͳ����Ա
		private String spwd;//ϵͳ����
		private String oroot;//���ݿ����Ա
		private String opwd;//���ݿ�����
		private String aroot;//Ӧ�ù���Ա
		private String apwd;//Ӧ������
		...
		private String typeclass;//Ʒ����
		private String paydate;//��������
		private String paypor;//�������
		private int lastday;//ʣ��ʱ��
		private String day;//Ĭ������ʱ��
		private String edi;//�༭
		private String del;//ɾ��
		private String con;//��ͬ
		private String conedit;//��ͬ
		private String condel;//��ͬ
		private String levela;//��ͬ
		private String time;//����ʱ��
		private String addevent;//����ʱ��
	...
	public  String[] list_check(String mantyp, String ...args) {
		...
		public static void main(String[] args) {
	        Equ test = new Equ();
	        String[] arr1= test.list_check("��", "��","��");
	        //System.out.println(test.list_check("��", "��","��"));
	      //  String[] arr1 = new String[2];
	        //arr1=test.list_check("��", "��","��");
